...
--demo_file=./surrol/data/demo/data_GauzeRetrieveContactApprox-v0_random_100.npz \
--save_path=./policies/herdemo/GauzeRetrieveContactApprox-demo1e5_0 \
--log_path=./logs/herdemo/GauzeRetrieveContactApprox-demo1e5_0 \
