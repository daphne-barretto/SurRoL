...
--demo_file=./surrol/data/demo/data_GauzeRetrieveAutoGrasp-v0_random_100.npz \
--save_path=./policies/herdemo/GauzeRetrieveAutoGrasp-demo1e5_1 \
--log_path=./logs/herdemo/GauzeRetrieveAutoGrasp-demo1e5_1 \
