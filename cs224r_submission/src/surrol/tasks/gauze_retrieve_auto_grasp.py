...
class GauzeRetrieveAutoGrasp(PsmEnv):
    """
    ...
    def _env_setup(self):
        super(GauzeRetrieveAutoGrasp, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(GauzeRetrieveAutoGrasp, self)._set_action(action)
...
if __name__ == "__main__":
    env = GauzeRetrieveAutoGrasp(render_mode='human')  # create one process and corresponding env
