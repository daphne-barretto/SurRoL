...
class GauzeRetrieveContactApproxCurriculumLearning(PsmEnv):
    """
    ...
    def _env_setup(self):
        super(GauzeRetrieveContactApproxCurriculumLearning, self)._env_setup()
        ...
        if alg == 'ddpgcl':
            file_path = './logs/ddpgcl/GauzeRetrieveContactApproxCurriculumLearning-1e5_0/progress.csv'
            try:
            ...
            file_path = './logs/hercl/GauzeRetrieveContactApproxCurriculumLearning-1e5_0/progress.csv'
            try:
                data = pd.read_csv(file_path)
                if data.empty:
                    epoch = 0
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(GauzeRetrieveContactApproxCurriculumLearning, self)._set_action(action)
...
if __name__ == "__main__":
    env = GauzeRetrieveContactApproxCurriculumLearning(render_mode='human')  # create one process and corresponding env
