...
class GauzeRetrieveContactApprox(PsmEnv):
    """
    ...
    def _env_setup(self):
        super(GauzeRetrieveContactApprox, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(GauzeRetrieveContactApprox, self)._set_action(action)
...
if __name__ == "__main__":
    env = GauzeRetrieveContactApprox(render_mode='human')  # create one process and corresponding env
