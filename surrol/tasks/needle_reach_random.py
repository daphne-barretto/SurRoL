...
class NeedleReachRandom(PsmEnv):
    """
    ...
    def _env_setup(self):
        super(NeedleReachRandom, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(NeedleReachRandom, self)._set_action(action)
...
if __name__ == "__main__":
    env = NeedleReachRandom(render_mode='human')  # create one process and corresponding env
