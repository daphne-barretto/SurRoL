...
class NeedlePickCurriculumLearning(PsmEnv):
    ...
    def _env_setup(self):
        super(NeedlePickCurriculumLearning, self)._env_setup()
...
if __name__ == "__main__":
    env = NeedlePickCurriculumLearning(render_mode='human')  # create one process and corresponding env
